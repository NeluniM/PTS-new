...
<div style="min-height: 850px;">
    <jsp:include page="../../common/navLisenceeBilling.jsp">
        ...
        <jsp:param name="description" value="Process Uploaded Meter-Reading Files"/>
    </jsp:include>

    <jsp:include page="meterProcessSelector.jsp">
        <jsp:param name="btnName" value="Process" />
    </jsp:include>

    <div id="resultContainer" class="tableContainer"></div>
</div>
<!-- ---------------------------------------------------------------------------------- -->
<!--                         FOOTER                                                     -->
<!-- ---------------------------------------------------------------------------------- -->
        ...
        function submitForm() {
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    ...
                    table.html("<div class='msg error-msg'>An unknown error occurred</div>");
                }
            });
        }
    });
