...
<div style="min-height: 850px;">
    <jsp:include page="../../common/navLisenceeBilling.jsp">
        ...
        <jsp:param name="description" value="Meter Management"/>
    </jsp:include>
    ...
    <div class="container mt-4">
        ...
        <p style="font-size: 15px; margin-bottom: 10px;">
            <a href="meterManagement/meterPointNew" style="text-decoration: none; color: black;">
                Meter Points
            </a>
        </p>
...
<!-- Same JS footer as other pages (optional but consistent) -->
