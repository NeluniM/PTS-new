...
public class Transformer {
    @Id
    @Column(name = "TRANSORMER_ID", nullable = false)
    private Long id;
    ...
    @Size(max = 100)
    @NotNull
    @Column(name = "TRANSORMER_NAME", nullable = false, length = 100)
    private String transormerName;

    @Size(max = 50)
    @NotNull
    @Column(name = "TANSFORMER_CODE", nullable = false, length = 50)
    private String tansformerCode;
